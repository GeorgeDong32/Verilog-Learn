...
#
# Generated by export_simulation on Fri May 12 16:41:20 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './div_gen_0.sh' script.

./div_gen_0.sh -reset_run
...
./div_gen_0.sh -noclean_files

For more information on the script, please type './div_gen_0.sh -help'.
